...
class AttrTrumps {
	...
	public $wrap                		= '';
	public $header_wrap                	= ' u-p- flex';
	public $header                		= ' shadow--z2 t-bg__1 u-mb@md u-mb+@lg u-mb- u-mb0@md'; 	// site-header
	...
	public $menu_primary 				= ' menu--horizontal flex flex--justify';	// menu menu-{$context}
