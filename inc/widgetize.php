...
function bempress_register_sidebars() {
	hybrid_register_sidebar( [
		...
		'before_widget'	=> '<section id="%1$s" class="widget widget-primary %2$s t-bg__2--light br u-p- u-p@md u-p+@lg u-mb- u-mb@md u-mb+@lg shadow--z1">',
	...
	hybrid_register_sidebar( [
		...
		'before_widget' => '<section id="%1$s" class="widget widget-footer %2$s u-pr- u-pr@md u-pr+@lg u-mb- u-mb@md u-mb+@lg grid__item grid__item--flexed"><div class="br widget__wrap t-bg__1--dark">',
