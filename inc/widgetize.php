...
function bempress_register_sidebars() {
    ...
    hybrid_register_sidebar( [
        ...
        'before_widget' => '<section id="%1$s" class="widget widget-panel %2$s u-pr@respond u-mb@respond grid__item flex"><div class="br widget__wrap u-p@respond t-bg__1--glass shadow--z1">',
        'after_widget'  => '</div></section>',
