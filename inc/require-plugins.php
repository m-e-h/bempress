<?php
/**
 * The plugins in this file are recommended for full function of this theme.
 *
...
add_action( 'tgmpa_register', 'bempress_register_required_plugins' );
 ...
 */
function bempress_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'MEH Slider',
			'slug'      => 'meh-slider',
			'source'    => 'https://github.com/m-e-h/meh-slider/archive/master.zip',
            'required'  => false,
		),
